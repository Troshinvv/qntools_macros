...
void run8_proton_centrality_comparison( std::string list, 
...
// - gamma fit 25.04 8120-8170
     std::vector<int>    multiplicity_edges{239,   176,    159,    145,    133,     122,     112,   102,     93,     85,   79, 50, 30, 17,  9,  5, 0}; // 8120-8170 new AllTr 25.042
...
hist2d.push_back( dd.Histo2D( { "h2_D_Gl_vs_I_FH", ";centrality, %(FH);centrality,%(Gl)", 11, -10.0, 100, 11, -10, 100  }, "centrality_fh", "centrality" ) );
hist2d.push_back( dd.Histo2D( { "h2_pqneg_vs_allTr", ";centrality, %(allTr);centrality,%(pq<0)", 50,0,100,50,0,100  }, "centrality", "centrality_pi" ) );
