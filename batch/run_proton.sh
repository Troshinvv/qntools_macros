...
output_dir=/nica/mpd1/vtroshin/bmn_protons/out
id=$SLURM_ARRAY_TASK_ID
input_list=/lhep/users/vtroshin/run8_vf_25.09_all_230826.list
split -l 29 -d -a 4 --additional-suffix=.txt $input_list $list_dir
#65_400
...
sleep 10
echo "Plain started"
time /lhep/users/vtroshin/qntools_macros/build/correct /lhep/users/vtroshin/qntools_macros/macro/final_push/run8_proton_qa.cc $list_dir/$file_list efficiency.2022.01.25.root run8_25.09_corrections.root 
